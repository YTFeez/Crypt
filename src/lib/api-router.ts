...
export const getFolderItems = impl.getFolderItems as (
  folderId: string,
  includeArchived?: boolean
) => ReturnType<typeof impl.getFolderItems>;
...
export const getArchivedFolderItems = impl.getArchivedFolderItems;
export const getArchivedDesigns = impl.getArchivedDesigns;
export const archiveFolderItem = impl.archiveFolderItem;
export const restoreFolderItem = impl.restoreFolderItem;
export const archiveDesign = impl.archiveDesign;
export const restoreDesign = impl.restoreDesign;
export const runAutoArchive = impl.runAutoArchive;
